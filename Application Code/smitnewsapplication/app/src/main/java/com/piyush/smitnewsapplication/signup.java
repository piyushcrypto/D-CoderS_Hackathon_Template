...
public class signup extends AppCompatActivity {
    ...
    private EditText name,username1, s1password,email,design, mobilenumber1,occupation,city;
        ...
        submitBtn.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      ...
                      boolean success= mydb.insertdata(username1.getText().toString(),email.getText().toString(),mobilenumber1.getText().toString(),s1password.getText().toString(),design.getText().toString());
                      if (success==true){
